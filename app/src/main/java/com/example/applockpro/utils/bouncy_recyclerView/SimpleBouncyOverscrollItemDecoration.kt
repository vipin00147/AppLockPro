...
internal class SimpleBouncyOverscrollItemDecoration(context: Context?, attrs: AttributeSet?, layoutManager: SimpleBouncyLayoutManager) :
    ...
    override fun onDraw(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        if (abs(_layoutManager.overscrollTotal) > Double.MIN_VALUE)
        {
    ...
    private fun drawOverscrollRegion(c: Canvas?, child: View?, start: Boolean){
        ...
        var overscrollAmount = abs(_layoutManager.overscrollTotal)
...
internal class SimpleBouncyOverscrollGridItemDecoration(context: Context?, attrs: AttributeSet?, layoutManager: SimpleBouncyStaggeredGridLayoutManager) :
    DividerItemDecoration(context, layoutManager.orientation) {

    private var _paint: Paint = Paint()

    private var _layoutManager: SimpleBouncyStaggeredGridLayoutManager = layoutManager
